    ...
    async getPublishedSectionsByCourse(
        ...
        return {
            sections: snapshot.sections.map((state) => ({
                ...
                accessGrantedAt: state.accessGrantedAt,
                isCurrentVersionCompleted: state.isCurrentVersionCompleted,
                hasNewContent: state.hasNewContent,
                completedLessonCount: state.completedLessonCount,
                totalLessonCount: state.totalLessonCount,
                newLessonCount: state.newLessonCount,
            })),
        };
    }
    ...
    async getTopicLearningPath(
        ...
        return {
            topic: {
                ...
                hasAccess: topic.hasAccess,
                accessGrantedAt: topic.accessGrantedAt,
                isCurrentVersionCompleted: topic.isCurrentVersionCompleted,
                hasNewContent: topic.hasNewContent,
                completedLessonCount: topic.completedLessonCount,
                totalLessonCount: topic.totalLessonCount,
                newLessonCount: topic.newLessonCount,
            },
            lessons: topic.lessons.map((state) => ({
                ...
                questionCount: state.publishedQuestionCount,
                publishedQuestionCount: state.publishedQuestionCount,
                currentVersion: state.currentVersion,
                completedVersion: state.completedVersion,
                isNewForUser: state.isNewForUser,
